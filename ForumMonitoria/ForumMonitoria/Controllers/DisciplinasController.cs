...
namespace ForumMonitoria.Controllers
{
    public class DisciplinasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Name")] Disciplina disciplina)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Name")] Disciplina disciplina)
        {
            if (id != disciplina.ID)
            {
                return NotFound();
